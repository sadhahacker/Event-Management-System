                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                                        ...
                                                        <main class="col-lg-6">
                                                            <div class="ps-lg-3">
                                                                ...
                                                                <div class="col-md-4 col-6 mb-3">
                                                                    <label
                                                                        class="mb-2 d-block">{{ __('localization.quantity') }}</label>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" id="buyticket"
                                                class="btn btn-primary">{{ __('localization.buy_tickets') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#button-addon1').on('click', function() {
                var currentValue = parseInt($('#ticketQuantity').val());
                if (!isNaN(currentValue) && currentValue > 1) {
                    $('#ticketQuantity').val(currentValue - 1);
                }
            });
            ...
            // Attach click event handler to "Save Changes" button in the modal
            $('#buyticket').click(function() {
                // Extract event ID and quantity from the modal
                ...
                // Make an AJAX request to buy tickets for the event
                $.ajax({
                    url: '/api/buyTicket', // URL of the API endpoint to buy tickets
                    type: 'POST',
                    data: {
                        eventId: eventId, // Send the event ID in the request body
                        quantity: quantity // Send the quantity in the request body
                        // You can include additional data such as user information, etc., as needed
            ...
            function fetchEvents(pageNumber, title, location, category) {
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        $('#topsellingcard').empty(); // Clear existing cards
                        data.data.forEach(function(event) {
                            $('#topsellingcard').append(`
        <div class="col">
            <div class="card shadow-sm" id="eventcard" data-id="${event.EventID}" data-toggle="modal" data-target=".bd-example-modal-xl"> <!-- Add data-id attribute with event ID and data-toggle and data-target -->
